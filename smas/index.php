...
<html lang="en">
    <head>
        ...
        <title>Student Marks Analyzing System</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="index.php">SMAS-(Student Marks Analyzing System)</a>
...
<?php }} ?>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white"> Student Marks Analyzing System <?php echo date('Y');?></p></div>
        </footer>
        <!-- Bootstrap core JS-->
